    ...
    <MainLayout>
      <div className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 text-center">
          ...
          >
            Mengenal lebih dekat sejarah, visi, misi, dan para pendidik inspiratif di balik kesuksesan kami.
          </motion.p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <h2 className="text-4xl font-bold font-display text-gray-900">Sejarah Kami</h2>
              <p className="text-lg text-muted-foreground">
                Didirikan pada tahun 2005, Sekolah Ceria berawal dari sebuah mimpi untuk menciptakan lingkungan belajar yang tidak hanya unggul secara akademis, tetapi juga menumbuhkan kreativitas dan karakter. Selama lebih dari 15 tahun, kami telah berkomitmen untuk memberikan pendidikan terbaik bagi generasi penerus bangsa.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0 }}>
              <Card className="h-full">
                <CardHeader>
                  <div className="mx-auto bg-school-yellow p-4 rounded-full w-fit"><Eye className="h-8 w-8 text-school-blue" /></div>
                  <CardTitle className="pt-4 font-display text-3xl">Visi</CardTitle>
                </CardHeader>
                <CardContent><p className="text-muted-foreground">Menjadi lembaga pendidikan terdepan yang menghasilkan individu cerdas, kreatif, berkarakter, dan siap menghadapi tantangan global.</p></CardContent>
              </Card>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }}>
              <Card className="h-full">
                <CardHeader>
                  <div className="mx-auto bg-school-yellow p-4 rounded-full w-fit"><Target className="h-8 w-8 text-school-blue" /></div>
                  <CardTitle className="pt-4 font-display text-3xl">Misi</CardTitle>
                </CardHeader>
                <CardContent><p className="text-muted-foreground">Menyelenggarakan pendidikan berkualitas, mengembangkan bakat siswa, menanamkan nilai-nilai luhur, dan membangun kemitraan dengan orang tua.</p></CardContent>
              </Card>
            </motion.div>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-4xl font-bold font-display text-gray-900">Tim Pengajar Kami</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Bertemu dengan para pendidik profesional dan berdedikasi yang siap membimbing putra-putri Anda.
            </p>
          </div>
