...
describe('NewsService - API Methods', () => {
  ...
  describe('listArticles', () => {
    ...
    it('should throw error on API failure', async () => {
      ...
      await expect(newsService.listArticles()).rejects.toThrow('Gagal memuat berita. Silakan coba lagi nanti.')
    })
  ...
  describe('getArticle', () => {
    ...
    it('should throw not found error when API returns 404', async () => {
      ...
      await expect(newsService.getArticle('nonexistent')).rejects.toThrow('Artikel tidak ditemukan')
    })
    ...
    it('should throw load failed error on API failure', async () => {
      ...
      await expect(newsService.getArticle('1')).rejects.toThrow('Gagal memuat artikel. Silakan coba lagi nanti.')
    })
