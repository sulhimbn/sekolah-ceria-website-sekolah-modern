...
export class UserEntity extends IndexedEntity<User> {
  ...
  /**
   * Find user by email - efficient lookup without fetching all users
   * Searches through seeded users and existing users
   */
...
export class NewsArticleEntity extends IndexedEntity<NewsArticle> {
  ...
  static readonly initialState: NewsArticle = {
    id: '',
    title: '',
    date: '',
    author: '',
